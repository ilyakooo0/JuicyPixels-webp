...
spec = do
  describe "Golden Tests" $ do
    describe "Known WebP Files" $ do
      ...
      -- NOTE: test_webp_js.webp was generated by a non-conformant encoder that
      -- expected decoders to have a specific bug (Word64 overflow in bit reading).
      -- This file does not decode correctly with a spec-compliant decoder.
      -- Skipping this test until a valid replacement test file is available.
      it "decodes test_webp_js.webp (VP8L lossless) correctly" $ do
        pendingWith "File was encoded by non-conformant encoder (see comment)"
