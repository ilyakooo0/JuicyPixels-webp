...
```
src/Codec/Picture/WebP.hs           -- public API (decode + encode)
src/Codec/Picture/WebP/Internal/    -- internal modules (40 total, ~11k lines)
PLAN.md                              -- original implementation plan (historical, decode-only)
